...
- Task Force Workshop, in-person, PowerUp 2026 (Colorado, USA), Friday September 11th (1.30pm local time). For full details see [here](https://github.com/frederikgeth/bmopf-report/blob/powerup-info/README.md).
